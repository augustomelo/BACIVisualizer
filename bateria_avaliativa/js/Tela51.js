var images = [];
images[0] = "../images/Memoria/prato.png";
images[1] = "../images/Memoria/coelho.png";
images[2] = "../images/Memoria/batom.png";
images[3] = "../images/Memoria/gato.png";
images[4] = "../images/Memoria/dado.png";
images[5] = "../images/Memoria/vaso.png";
images[6] = "../images/Memoria/gude.png";
images[7] = "../images/Memoria/violao.png";
images[8] = "../images/Memoria/pincel.png";
images[9] = "../images/Memoria/flor.png";
...
function voltar()
{
		...
		window.location.href = "Tela50.html"
}
...
function proximo(form) {
	...
	for(i = 0; i < json.Paciente.Pacientes.length; i++)
	{
		...
		{
			if(json.Paciente.Pacientes[i].TelaAtual < 52)
				json.Paciente.Pacientes[i].TelaAtual = 52;
			var ls = JSON.stringify(json);
			localStorage.setItem('Pacientes', ls);
			form.action = "Tela52.html";
			break;
		}
	}
}
